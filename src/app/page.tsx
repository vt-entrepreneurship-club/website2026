  ...
  return (
    <main className="bg-background text-foreground">
          ...
          <div className="flex items-center justify-between w-full max-w-3xl">
            {navItems.map((item) => (
              <a
                key={item.href}
                href={item.href}
                className="font-[family-name:var(--font-serif)] text-base hover:text-accent transition-colors duration-200 underline underline-offset-2 decoration-foreground/30 decoration-1"
              >
                {item.label}
              </a>
            ))}
      ...
      <section
        ...
        style={{ opacity: heroFade.opacity, transition: 'opacity 0.1s ease-out' }}
      >
        {/* Background Image - Zoomed to fit */}
        <div 
        ...
        <div className="absolute bottom-[25%] right-[30%] z-20 translate-y-[50px] -translate-x-[50px]">
          <span className="font-[family-name:var(--font-serif)] text-sm italic text-foreground">fig 01.</span>
        </div>
        
        {/* Scrolling Sideways Text - Right Edge */}
        <div className="absolute right-0 top-0 h-screen z-10 overflow-hidden flex justify-end">
          <p 
            className="font-['AS_Therma_Light'] text-4xl md:text-5xl lg:text-6xl tracking-tighter text-accent whitespace-nowrap animate-[scroll-vertical_19s_linear_infinite]"
        ...
        <div className="relative z-10 w-full h-full flex flex-col justify-end pb-8 md:pb-10 lg:pb-12 px-8 md:px-12 lg:px-16">
          <div className="text-left">
            <h1 className="font-[family-name:var(--font-therma)] text-[2.5rem] sm:text-[3.3rem] md:text-[5rem] lg:text-[6.6rem] xl:text-[8.8rem] tracking-tight uppercase leading-[0.85]">
              Virginia Tech
            </h1>
            <h1 className="font-[family-name:var(--font-therma)] text-[2.5rem] sm:text-[3.3rem] md:text-[5rem] lg:text-[6.6rem] xl:text-[8.8rem] tracking-tight uppercase leading-[0.85] text-accent mt-1">
              Entrepreneurship Club
            </h1>
            <p className="font-[family-name:var(--font-serif)] text-base md:text-lg lg:text-xl leading-relaxed italic text-foreground/60 mt-5">
        ...
        <div className="max-w-6xl w-full">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-16">
            <div className="text-center">
              ...
              <p className="font-[family-name:var(--font-serif)] text-lg mt-4 italic text-foreground/70">
      ...
      >
        <div className="max-w-3xl text-center">
          ...
          <p className="font-[family-name:var(--font-serif)] text-xl md:text-2xl leading-relaxed mb-12 italic">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {teamMembers.map((member, index) => (
              ...
              >
                ...
                <p className="font-[family-name:var(--font-serif)] text-sm mt-1 italic opacity-70">
                  {member.role}
                </p>
              </div>
            ))}
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="flex items-center gap-6">
              ...
              />
              <p className="font-[family-name:var(--font-serif)] text-lg italic">
                The official launchpad for Hokie innovation.
              </p>
            </div>
